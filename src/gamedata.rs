...
pub const TORMENT_BASE_DAMAGE: f64 = 22.;
pub const TORMENT_MULTIPLIER: f64 = 0.06;
pub const TORMENT_MOVING_BASE_DAMAGE: f64 = 31.8;
pub const TORMENT_MOVING_MULTIPLIER: f64 = 0.09;
